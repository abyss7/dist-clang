...
const ::google::protobuf::EnumDescriptor* Metric_Name_descriptor_ = NULL;

}  // namespace


void protobuf_AssignDesc_perf_2fstat_2eproto() {
  protobuf_AddDesc_perf_2fstat_2eproto();
  ...
  Metric_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      ...
      sizeof(Metric));
  Metric_Name_descriptor_ = Metric_descriptor_->enum_type(0);
}
...
inline void protobuf_AssignDescriptorsOnce() {
  ::google::protobuf::GoogleOnceInit(&protobuf_AssignDescriptors_once_,
                 &protobuf_AssignDesc_perf_2fstat_2eproto);
}
...
void protobuf_AddDesc_perf_2fstat_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "erf.proto.Metric.Name\022\r\n\005value\030\002 \001(\004\"\321\001\n"
    ...
    "\020\007\022\026\n\022CACHE_SIZE_CLEANED\020\010\022\024\n\020CACHE_SIZE"
    "_ADDED\020\t", 328);
  ...
  ::google::protobuf::internal::OnShutdown(&protobuf_ShutdownFile_perf_2fstat_2eproto);
}

// Force AddDescriptors() to be called at static initialization time.
struct StaticDescriptorInitializer_perf_2fstat_2eproto {
  StaticDescriptorInitializer_perf_2fstat_2eproto() {
    protobuf_AddDesc_perf_2fstat_2eproto();
  }
} static_descriptor_initializer_perf_2fstat_2eproto_;

// ===================================================================

const ::google::protobuf::EnumDescriptor* Metric_Name_descriptor() {
  protobuf_AssignDescriptorsOnce();
  return Metric_Name_descriptor_;
}
...
#ifndef _MSC_VER
const Metric_Name Metric::DIRECT_CACHE_HIT;
...
const Metric_Name Metric::CACHE_SIZE_CLEANED;
const Metric_Name Metric::CACHE_SIZE_ADDED;
...
Metric::Metric()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:dist_clang.perf.proto.Metric)
}
...
Metric::Metric(const Metric& from)
  ...
  SharedCtor();
  MergeFrom(from);
  // @@protoc_insertion_point(copy_constructor:dist_clang.perf.proto.Metric)
}
...
Metric::~Metric() {
  // @@protoc_insertion_point(destructor:dist_clang.perf.proto.Metric)
  SharedDtor();
}
...
const Metric& Metric::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_perf_2fstat_2eproto();
...
#define DO_(EXPRESSION) if (!(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:dist_clang.perf.proto.Metric)
  for (;;) {
      ...
      case 1: {
        if (tag == 8) {
          ...
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                 ...
                 input, &value)));
          if (::dist_clang::perf::proto::Metric_Name_IsValid(value)) {
            set_name(static_cast< ::dist_clang::perf::proto::Metric_Name >(value));
          } else {
...
success:
  // @@protoc_insertion_point(parse_success:dist_clang.perf.proto.Metric)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:dist_clang.perf.proto.Metric)
  return false;
#undef DO_
}
...
void Metric::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:dist_clang.perf.proto.Metric)
  // required .dist_clang.perf.proto.Metric.Name name = 1;
  if (has_name()) {
  ...
  // @@protoc_insertion_point(serialize_end:dist_clang.perf.proto.Metric)
}

::google::protobuf::uint8* Metric::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // @@protoc_insertion_point(serialize_to_array_start:dist_clang.perf.proto.Metric)
  // required .dist_clang.perf.proto.Metric.Name name = 1;
  if (has_name()) {
  ...
  // @@protoc_insertion_point(serialize_to_array_end:dist_clang.perf.proto.Metric)
  return target;
}
